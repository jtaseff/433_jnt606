...
//    };
    ...
    public void sendImage(File photo) {
        ...
        Bitmap rotatedBitmap = Bitmap.createBitmap(crop , 0, 0, crop .getWidth(), crop .getHeight(), matrix, true);
        ...
        // Display our bitmap
        ourImage.setImageBitmap(rotatedBitmap);
...
//        }
        ...
        cameraStatus.setText("Image sent");
    }
}
