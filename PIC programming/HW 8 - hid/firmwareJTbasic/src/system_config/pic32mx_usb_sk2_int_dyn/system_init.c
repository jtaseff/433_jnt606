// this file specific to this project
// JT - modified to run JT250 pragmas
// added initialization code for OLED and accelerometer
...
#pragma config FUSBIDIO = OFF // USB pins controlled by USB module - want this off for I2C
#pragma config FVBUSONIO = OFF // controlled by USB module - off for I2C
